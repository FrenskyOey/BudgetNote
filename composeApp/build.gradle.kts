...
buildkonfig {
    ...
    defaultConfigs {
        ...
        buildConfigField(STRING, "SUPABASE_URL", localProperties.getProperty("staging.SUPABASE_URL") ?: "")
    ...
    defaultConfigs("production") {
        ...
        buildConfigField(STRING, "SUPABASE_URL", localProperties.getProperty("production.SUPABASE_URL") ?: "")
